...
<template>
  <main class="hero">
    <section class="card intro">
      ...
      <p>
        Проект стартует на: бэкенд - Rails API для более быстрого прототипирования, все уязвимые вычисления происходят здесь, фронтенд - Vue 3 Composition API для максимальной гибкости и реактивности интерфейсов, в случаях высоконагруженных мест на сайте, производится вынос в модуль на более быстрый язык
      </p>
    </section>
